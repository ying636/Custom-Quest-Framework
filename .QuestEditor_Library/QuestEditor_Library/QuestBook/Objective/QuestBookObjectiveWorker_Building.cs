...
{
    public class QuestBookObjectiveWorker_Building : QuestBookObjectiveWorker
    {
        ...
        public override bool Check(QuestBookObjective objective, QuestBookObjectiveProgress progress)
        {
            ...
            int count = Find.Maps.Where(map => map.IsPlayerHome)
                .Sum(map => map.listerBuildings.AllBuildingsColonistOfDef(objective.targetThingDef).Count);
